...
for(int i=4;i<=13;i++){
	...
	WebUI.setText(findTestObject('Mes rapports Obj/CONTENU/input_Contenu_Selecteur'), excelData.getValue(i, 3))
	WebUI.delay(3)
	def selecteur = new TestObject('Choisir_selecteur')
	selecteur.addProperty('xpath', ConditionType.EQUALS, "//span[contains(text(),\'"+ excelData.getValue(i, 3) +"\')]")
